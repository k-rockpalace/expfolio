$(function() {
	...
	var Particle = function(x, y, vx, vy, ax, ay, colour) {
		...
		this.draw = function() {
			...
			// tail      
			ctx.fillStyle = 'rgba(' + this.colour + (opacity * 0.5) + ')';
			if (this.life > LIFE * 0.95) ctx.fillStyle = '#ffff00';
			ctx.lineWidth = 1;
			ctx.beginPath();
	...
	var Firework = function() {
		...
		var colorElem = ['255,153,0','255,0,0','0,0,255','255,102,153','0,204,204','255,204,0'];
		this.colour = colorElem[Math.floor(Math.random()*colorElem.length)];
